    ...
    return (
        <div className='header'>
            <Nav className='d-flex justify-content-center pt-3'>
                <Link className='ps-4 text-white text-decoration-none icon-link'>Home</Link>
                <Link className='ps-4 text-white text-decoration-none icon-link'>About</Link>
                <Link className='ps-4 text-white text-decoration-none icon-link'>Login</Link>
            </Nav>
